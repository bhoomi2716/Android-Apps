...
import com.example.meditation.databinding.FragmentMaleVoiceBinding
import com.dev.meditation.model.ModelMusicPlayerViewPager

class MaleVoiceFragment : Fragment()
{
    private lateinit var binding: FragmentMaleVoiceBinding
    ...
    {
        binding = FragmentMaleVoiceBinding.inflate(layoutInflater)
    ...
    private fun setRecyclerItem(){
        ...
        recyclerItems.add(ModelMusicPlayerViewPager
            (resources.getString(R.string.body_scan),resources.getString(R.string.one_min_fifty_eight_sec),R.raw.body_scan_music))
        recyclerItems.add(ModelMusicPlayerViewPager
        ...
        binding.recyclerViewPager.setHasFixedSize(true)
